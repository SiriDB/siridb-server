...
enum cleri_grammar_ids {
    ...
    CLERI_GID_HELP_ALTER_NETWORK,
    CLERI_GID_HELP_ALTER_SERIES,
    CLERI_GID_HELP_ALTER_SERVER,
    CLERI_GID_HELP_ALTER_USER,
    CLERI_GID_HELP_CONTINUE,
    CLERI_GID_HELP_COUNT,
    CLERI_GID_HELP_COUNT_GROUPS,
    CLERI_GID_HELP_COUNT_NETWORKS,
    ...
    CLERI_GID_K_NAME,
    CLERI_GID_K_NETWORK,
    CLERI_GID_K_NETWORKS,
    CLERI_GID_K_NOW,
    CLERI_GID_K_ONLINE,
    CLERI_GID_K_OPEN_FILES,
    CLERI_GID_K_OPTIMIZE_POOL,
    CLERI_GID_K_OPTIMIZE_TASK,
    CLERI_GID_K_OR,
    ...
    CLERI_GID_K_SET,
    CLERI_GID_K_SHARD,
    CLERI_GID_K_SHARDING_BUFFERING,
